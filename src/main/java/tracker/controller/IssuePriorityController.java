...
public class IssuePriorityController {
    ...
    @PostMapping("/create")
    public ModelAndView createNewIssuePriority(@ModelAttribute @Valid IssuePriority issuePriority, BindingResult result,
    ...
    public ModelAndView deleteIssuePriority(@PathVariable Integer id, final RedirectAttributes redirectAttributes) {
        ...
        try {
            ...
            message = "IssuePriority \"" + issuePriority.getId() + ": " + issuePriority.getName()
                    + "\" has been deleted.";
    ...
    @PostMapping("/save/{id}")
    public ModelAndView saveIssuePriority(@ModelAttribute @Valid IssuePriority issuePriority, BindingResult result,
