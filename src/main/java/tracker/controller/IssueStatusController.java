...
public class IssueStatusController {
    ...
    @PostMapping("/create")
    public ModelAndView createNewIssueStatus(@ModelAttribute @Valid IssueStatus issueStatus, BindingResult result,
    ...
    @PostMapping("/save/{id}")
    public ModelAndView saveIssueStatus(@ModelAttribute @Valid IssueStatus issueStatus, BindingResult result,
