...
<body onload="parentChanged();">
	...
	<form:form method="POST" commandName="issue"
		action="${pageContext.request.contextPath}/issue/save/${issue.id}">
		<table>
			<tbody>
				<tr>
					<td>Name:</td>
				...
				<tr>
					<td>Parent issue:</td>
					<td><form:select path="parent.id" items="${issues}" itemLabel="name" multiple="false" itemValue="id" onchange="parentChanged()" /></td>
